                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex pt-4">
                        ...
                        <div class="ml-3 relative">
                            <x-jet-dropdown align="right" width="48">
                                ...
                                $anos = [];
                                for ($index = date('Y') + 1; $index >= 2023; $index -= 1) {
                    ...
                    <div class="ml-3 relative">
                        <x-jet-dropdown align="right" width="48" :active="\Request()->routeIs('rel.*')">
                            ...
                            <x-slot name="content">
                                ...
                                <x-jet-dropdown-link href="{{ url($ano . '/rel/gestores') }}" :active="request()->routeIs('rel.gestores')">
                                    {{ __('Gestores') }}
                                </x-jet-dropdown-link>
            ...
            <div class="lg:flex sm:ml-6 pt-4">
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        $anos = [];
                        for ($index = date('Y'); $index >= 2023; $index -= 1) {
                            $anos[$index * 1] = $index * 1;
                        }
