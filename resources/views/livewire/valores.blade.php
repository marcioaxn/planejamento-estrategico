                ...
                <div class="flex flex-wrap w-full">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 pt-1">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <x-jet-label for="cod_pei" value="Os Valores serão para qual PEI?"/>
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 pt-1">
                     ...
                     <div class="w-full md:w-1/3 px-3 pt-6 mb-3 md:mb-0 pt-1">

                        <div class="col-span-6 sm:col-span-4">
                            <x-jet-label for="nom_valor" value="Valor"/>
                            {!! Form::text('nom_valor',null,['class' => 'border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 pt-2 pl-2','id' => 'nom_valor', 'placeholder' => 'Escreva aqui os valores', 'required' => 'required', 'style' => 'width: 100%', 'wire:model' => 'nom_valor']) !!}
                            <x-jet-input-error for="nom_valor" class="mt-2"/>
                        </div>

                    </div>

                     <div class="w-full md:w-2/3 px-3 pt-6 mb-3 md:mb-0 pt-1">

                        <div class="col-span-6 sm:col-span-4">
                            <x-jet-label for="dsc_valor" value="Descrição do Valor"/>
                            {!! Form::textarea('dsc_valor',null,['class' => 'border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 pt-2 pl-2','id' => 'dsc_valor', 'placeholder' => 'Escreva aqui os valores', 'rows' => 3, 'required' => 'required', 'style' => 'width: 100%', 'wire:model' => 'dsc_valor']) !!}
                            <x-jet-input-error for="dsc_valor" class="mt-2"/>
                        </div>
                ...
                <table class="divide-gray-300 min-w-full border-collapse block md:table ">
                    ...
                    <tr class="shadow-lg">
                        <th class="bg-gray-400 px-6 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell"
                            style="text-align: left!Important;">Valor
                        </th>
                        <th class="bg-gray-400 px-6 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell"
                            style="text-align: left!Important;">Descrição do Valor
                        </th>
                        <th class="bg-gray-400 px-6 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell"
                            style="text-align: left!Important;">PEI
                        </th>
                        <th class="bg-gray-400 px-6 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell"
                            style="text-align: left!Important;">Unidade
                        </th>
                        <th class="bg-gray-400 px-6 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell"
                    ...
                    @foreach ($this->valores as $result)
                        ...
                        <tr class="border border-gray-500 md:border-none block md:table-row">
                            ...
                            <td class="p-2 md:border md:border-gray-100 text-left block md:table-cell px-5 py-3 text-sm text-gray-600">
                                {{ $result->planejamentoEstrategicoIntegrado->dsc_pei }}
                                ( {!! $result->planejamentoEstrategicoIntegrado->num_ano_inicio_pei !!}
                                a {!! $result->planejamentoEstrategicoIntegrado->num_ano_fim_pei !!} )
                            </td>
                            <td class="p-2 md:border md:border-gray-100 text-left block md:table-cell px-5 py-3 text-sm text-gray-600">
    ...
    <x-jet-dialog-modal wire:model="showModalDelete">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button wire:click.prevent="$toggle('showModalDelete')" wire:loading.attr="disabled"
                                 wire:click.prevent="delete('{!! $this->cod_valor !!}')">
                Sim, quero excluir
            </x-jet-danger-button>
        </x-slot>
    </x-jet-dialog-modal>
