                ...
                <div class="flex flex-wrap w-full">
                    ...
                    <div class="w-full md:w-1/2 px-3 pt-6 mb-3 md:mb-0 pt-1">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            {!! Form::textarea('dsc_visao',null,['class' => 'border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 pt-2 pl-2','id' => 'dsc_visao', 'placeholder' => 'Escreva aqui a visão', 'rows' => 3, 'required' => 'required', 'style' => 'width: 100%', 'wire:model' => 'dsc_visao']) !!}
                ...
                <table class="divide-gray-300 min-w-full border-collapse block md:table ">
                    ...
                    <tr class="shadow-lg">
                        <th class="bg-gray-400 px-6 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell"
                            style="text-align: left!Important;">Missão
                        </th>
                        <th class="bg-gray-400 px-6 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell"
                            style="text-align: left!Important;">Visão
                        </th>
                        <th class="bg-gray-400 px-6 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell"
                    ...
                    @foreach ($this->MissaoVisao as $result)
                        ...
                        <tr class="border border-gray-500 md:border-none block md:table-row">
                            ...
                            <td class="p-2 md:border md:border-gray-100 text-left block md:table-cell px-5 py-3 text-sm text-gray-600">
                                <a href="javascript: void(0);"
                                   wire:click.prevent="editForm('{!! $result->cod_missao_visao_valores !!}')"
                                   onclick="javascript: document.documentElement.scrollTop = 0;"><i
                                        class="fas fa-edit text-green-600"></i></a>

                                <button type="button"
                                        wire:click.prevent="deleteForm('{!! $result->cod_missao_visao_valores !!}')"><i
    ...
    <x-jet-dialog-modal wire:model="showModalDelete">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button wire:click.prevent="$toggle('showModalDelete')" wire:loading.attr="disabled"
                                 wire:click.prevent="delete('{!! $this->cod_missao_visao_valores !!}')">
                Sim, quero excluir
            </x-jet-danger-button>
        </x-slot>
    </x-jet-dialog-modal>
