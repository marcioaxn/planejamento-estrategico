    ...
    <div class="flex flex-wrap w-full text-base md:text-sm pt-1 pb-3 pl-3 pr-3 rounded-md border-1 border-gray-100">
        ...
        <div class="w-full md:w-5/6 border-b-2 border-gray-100 pt-0 pb-2 pl-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 gap-2 mt-0">
                ...
                <div class="pt-2 pb-1 pl-2 text-base text-lef bg-white-500 text-{!! $resultado['grau_de_satisfacao'] !!}-600 rounded-md border-2 border-gray-100 shadow cursor-pointer" onclick="javascript: alterarIndicador('<?php print($indicador->cod_indicador) ?>');">
                            ...
                            <table class="min-w-full">
                                <thead class="border-b">
                                    ...
                                    <tr class="">
                                        ...
                                        <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>Meta</strong></th>
                                        ...
                                        <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>{!! mesNumeralParaExtensoCurto($evolucaoIndicador->num_mes) !!}</strong></th>
                                        ...
                                        <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>Acumulado até {!! mesNumeralParaExtensoCurto($this->mesAnterior) !!}</strong></th>

                                        @else

                                        <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>Total</strong></th>
                                ...
                                <tbody class="">
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>Prevista</strong></td>
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>Realizada</strong></td>
                                        ...
                                        <tr class="border-b">
                                            ...
                                            <td class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>Atualização</strong></td>
      ...
      <div class="overflow-x-auto">
                        ...
                        <table class="min-w-full">
                                ...
                                <tr class="border-b">
                                    ...
                                    <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong></strong>Mês</th>
                                    <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>Meta Prevista</strong></th>
                                    <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>Meta Realizada</strong></th>

                                    <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-left">A<strong>valiação qualitativa</strong></th>
                                    <th class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-left"><strong>Arquivos</strong></th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="text-sm text-gray-900 px-6 py-4 whitespace-nowrap text-right"><strong>{!! mesNumeralParaExtensoCurto($evolucaoIndicador->num_mes) !!}</strong></td>
                                    ...
                                    @if($evolucaoIndicador->num_mes <= $this->mesAnterior)
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 break-words text-justify" style="width: 45%!Important;">
