                    ...
                    <table class="divide-gray-300 min-w-full border-collapse block md:table ">
                        <thead class="hidden shadow-lg inset-x-0 top-16 block md:table-header-group">
                            <tr class="shadow-lg">
                                ...
                                <th class="bg-gray-400 px-1 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-right block md:table-cell" style="text-align: right!Important;">Orçamento Previsto</th>
                                <th class="bg-gray-400 px-1 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell" style="text-align: left!Important;">Servidor(a) Responsável e Substituto(a)</th>
                                <th class="bg-gray-400 px-1 py-2 text-xs text-white font-bold md:border md:border-gray-100 text-left block md:table-cell" style="text-align: left!Important;">Objetivo Estratégico</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-300 block md:table-row-group">
                            ...
                            <tr class="border border-gray-500 md:border-none block md:table-row">
                                ...
                                <td class="p-2 md:border md:border-gray-100 text-left block md:table-cell py-3 text-sm text-gray-600">
                                    <span class="text-gray-400">Início em</span> {{ converterData('EN','PTBR',$result->dte_inicio) }}<span class="text-gray-400"> - {{ formatarDataComCarbonForHumans($result->dte_inicio) }}</span> / <span class="text-gray-400">Conclusão em</span> {{ converterData('EN','PTBR',$result->dte_fim) }}
                                </td>
                                <td class="p-2 md:border md:border-gray-100 text-left block md:table-cell py-3 text-sm text-gray-600">
                                    {{ $result->bln_status }}
                                </td>
                                <td class="p-2 md:border md:border-gray-100 text-left block md:table-cell py-3 text-sm text-gray-600 text-right">
                                ...
                                <td class="p-2 md:border md:border-gray-100 text-left block md:table-cell py-3 text-sm text-gray-600 w-36 ">
