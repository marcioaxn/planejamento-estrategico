        ...
        <div class="bg-white rounded-lg overflow-hidden border-2 {{ $border }} mb-2">
            ...
            @if ($resultPerspectiva->objetivosEstrategicos->count() > 0)
                <div>
                    ...
                    @if ($resultPerspectiva->objetivosEstrategicos->count() > 0)
                        <div
                            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-4 p-3 pt-5 pb-5">
                                            ...
                                            <div class="principal_div mt-0 pt-0 mb-0 pb-0"
                                                ...
                                                <div class="flex justify-between mb-1">
                                                    <span class="text-xs text-gray-500">
                                                        {!! !is_null($result['quantidadePlanosDeAcao']) ? $result['quantidadePlanosDeAcao'] : 0 !!}
                                                        Indicador(es)
                                                    </span>
                                                ...
                                                <div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
                                                    <div class="bg-{{ $result['grau_de_satisfacao'] }}-600 h-1.5 rounded-full"
                                                        style="width: {{ $result['percentual_alcancado'] }}%"></div>
                                                </div>
                                            </div>
