    ...
    <div class="">
        ...
        <div class="flex flex-wrap w-full pt-1">
            ...
            <div class="w-full md:w-1/1 px-3 pt-1">
                ...
                <div class="pt-1 pb-1 pl-3 pr-3 bg-white rounded-md border-2 border-gray-300 border-opacity-25 text-gray-600 text-lg items-center font-semibold text-lg "
            ...
            @if (isset($this->missaoVisaoValores) && !is_null($this->missaoVisaoValores) && $this->missaoVisaoValores != '')
                <div class="w-full md:w-1/2 px-3 md:px-1 md:pl-3 pt-1 md:mb-0 pt-2">
                    ...
                    <div class="bg-white rounded-lg overflow-hidden border-2 border-yellow-400 mb-2">
                        ...
                        <div class="pt-2 pb-3 pl-3 pr-3 sm:h-24">
                ...
                <div class="w-full md:w-1/2 px-3 md:px-1 md:pl-3 pt-1 md:mb-0 pt-2">
                    ...
                    <div class="bg-white rounded-lg overflow-hidden border-2 border-sky-700 mb-2">

                        <div class="bg-sky-700 text-white text-lg px-1 pt-1 pb-1 pl-3 pr-3">
                            <strong>Visão</strong>
                        </div>
                ...
                <div class="w-full md:w-1/1 px-3 md:px-1 md:pl-3 pt-1 md:mb-0 pt-2">

                    <div class="bg-white rounded-lg overflow-hidden border-2 border-green-600 mb-2">

                        <div class="bg-green-600 text-white text-lg px-1 pt-1 pb-1 pl-3 pr-3">
                ...
                @foreach ($this->perspectiva as $resultPerspectiva)
                    ...
                    <div class="bg-white rounded-lg overflow-hidden border-2 {{ $border }} mb-2">
                        ...
                        <div class="bg-{{ $colorBg . ' ' . $border }} text-lg px-1 pt-1 pb-1 pl-3 pr-3">
                            <span class="text-sm">{!! $resultPerspectiva->num_nivel_hierarquico_apresentacao !!}.
                            </span><strong>{!! $resultPerspectiva->dsc_perspectiva !!}</strong>
                        </div>

                        @if ($resultPerspectiva->objetivosEstrategicos->count() > 0)
                            <div
                                class="grid lg:grid-flow-row grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-5 2xl:grid-cols-6.9 sm:grid-rows-{!! ceil(
                                    $resultPerspectiva->objetivosEstrategicos->count() / $resultPerspectiva->objetivosEstrategicos->count(),
                                ) !!} md:grid-rows-{!! ceil($resultPerspectiva->objetivosEstrategicos->count() / 2) !!} lg:grid-rows-{!! ceil($resultPerspectiva->objetivosEstrategicos->count() / 2) !!} xl:grid-rows-{!! ceil($resultPerspectiva->objetivosEstrategicos->count() / 5) !!} 2xl:grid-rows-{!! ceil($resultPerspectiva->objetivosEstrategicos->count() / 6) !!} gap-4 w-full mt-1 mb-1 px-1 pt-2 pb-2 pl-2 pr-2">
                                ...
                                @foreach ($resultPerspectiva->objetivosEstrategicos as $resultObjetivoEstragico)
                                    <a href="{!! url(
                                        ...
                                        <div
                                            class="pt-2 pb-2 pl-3 pr-3 bg-white rounded-md border-2 {{ $border }} border-opacity-50 shadow ">

                                            <div id="load-objetivo-estrategico-{!! $resultObjetivoEstragico->cod_objetivo_estrategico !!}"
                                            ...
                                            <div id="objetivo-estrategico-{!! $resultObjetivoEstragico->cod_objetivo_estrategico !!}" class="w-full"
                                                style="width: 100%!Important; display: none;">

                                                <p class="w-full text-lg text-start text-gray-600 h-40 xl:h-60 2xl:h-40"
                                                    style="width: 100%!Important;"><strong>OE
                                                        {!! $resultObjetivoEstragico->num_nivel_hierarquico_apresentacao !!}.</strong> {!! $resultObjetivoEstragico->dsc_objetivo_estrategico !!}</p>
                                                ...
                                                <div class="w-full pt-1" style="width: 100%!Important;">
                                                    ...
                                                    <div class="flex mb-2 items-center justify-between"
                                                        ...
                                                        <div class="text-xs text-gray-500">{!! $result['quantidadePlanosDeAcao'] !!}
                                                            ações/iniciativas /projetos</div>

                                                        <div class="text-right">

                                                            <span
                                                                class="text-xs font-semibold inline-block text-gray-500">{!! converteValor('MYSQL', 'PTBR', $result['percentual_alcancado']) !!}%</span>

                                                        </div>

                                                    </div>

                                                    <div class="overflow-hidden h-2 text-xs flex rounded bg-{{ $result['grau_de_satisfacao'] }}-50"
                                                        style="width: 100%!Important;">

                                                        <div style="width:{!! $result['percentual_alcancado'] !!}%"
                                                            class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-{{ $result['grau_de_satisfacao'] }}-500 ">
                                                        </div>
