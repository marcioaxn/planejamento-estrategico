<div class="pt-3 pb-3 pl-1 pr-1">
    ...
    <div class="flex flex-wrap w-full text-base md:text-sm pt-1 pb-3 pl-3 pr-3 rounded-md border-1 border-gray-100"
        ...
        @if ($this->indicadoresObjetivoEstrategico)
            ...
            <div class="w-full md:w-2/6 border-b-2 border-gray-100 pt-2 pb-2 pl-1">
                Indicador terá o resultado acumulado? <strong>{{ $this->objetivoEstrategico->primeiroIndicador->bln_acumulado }}</strong>
            </div>

            <div class="w-full md:w-2/6 border-b-2 border-gray-100 pt-2 pb-2 pl-1">
                Tipo de Análise (Polaridade): <strong>{{ tipoPolaridade($this->objetivoEstrategico->primeiroIndicador->dsc_tipo) }}</strong>
            </div>

            <div class="w-full md:w-2/6 border-b-2 border-gray-100 pt-2 pb-2 pl-1">
                Período de medição: <strong>{{ $this->objetivoEstrategico->primeiroIndicador->dsc_periodo_medicao }}</strong>
            </div>
            ...
            <div class="w-full md:w-2/6 border-b-2 border-gray-100 pt-2 pb-2 pl-1">
                Fórmula do Indicador: <strong>{{ nl2br($this->objetivoEstrategico->primeiroIndicador->dsc_formula) }}</strong>
            </div>
                                                    ...
                                                    <tbody class="">
                                                        ...
                                                        <tr class="border-b">
                                                            ...
                                                            @if ($this->objetivoEstrategico->primeiroIndicador->bln_acumulado == 'Sim')
                                                                <td
                                                                    class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap text-right">
                                                                    {!! formatarValorConformeUnidadeMedida($this->objetivoEstrategico->primeiroIndicador->dsc_unidade_medida, 'MYSQL', 'PTBR', $totalPrevisto) !!}<?php $this->objetivoEstrategico->primeiroIndicador->dsc_unidade_medida === 'Porcentagem' ? print '%' : print ''; ?>
                                                                </td>
                                                            @endif
        ...
        @if ($this->objetivoEstrategico->primeiroIndicador->bln_acumulado == 'Sim')
            ...
            <td class="text-sm text-gray-900 font-light whitespace-nowrap text-right">
                ...
                <div
                    ...
                    {!! formatarValorConformeUnidadeMedida($this->objetivoEstrategico->primeiroIndicador->dsc_unidade_medida, 'MYSQL', 'PTBR', $totalRealizado) !!}<?php $this->objetivoEstrategico->primeiroIndicador->dsc_unidade_medida === 'Porcentagem' ? print '%' : print ''; ?>
                                ...
                                @if ($evolucaoIndicador->num_mes <= $this->mesAnterior)
                                    <td class="text-sm text-gray-900 px-6 py-4 font-light whitespace-nowrap text-right">
                                        ...
                                        <span class="cursor-pointer"
                                            title="Incluir PDF para o mês de {!! mesNumeralParaExtensoCurto($evolucaoIndicador->num_mes) !!}"
                                        ...
                                        <a href="javascript: void(0);"
                                            wire:click.prevent="editForm('{!! $evolucaoIndicador->cod_evolucao_indicador !!}')"
