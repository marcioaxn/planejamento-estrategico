...
function nomeCampoTabelaNormalizado($campo) {
    ...
    switch ($campo) {
        ...
        break;
        case 'cod_objetivo_estrategico': $campoNormalizado = 'Objetivo Estratégico';
        break;
        case 'cod_tipo_execucao': $campoNormalizado = 'Tipo';
        break;
        case 'num_nivel_hierarquico_apresentacao': $campoNormalizado = 'Código';
        break;
        case 'cod_organizacao': $campoNormalizado = 'Unidade Responsável';
        break;
        case 'dsc_plano_de_acao': $campoNormalizado = 'Descrição';
        break;
        case 'txt_principais_entregas': $campoNormalizado = 'Principais entregas';
        break;
        case 'dte_inicio': $campoNormalizado = 'Data de Início';
        break;
        case 'dte_fim': $campoNormalizado = 'Data de Conclusão';
        break;
        case 'bln_status': $campoNormalizado = 'Status';
        break;
        case 'vlr_orcamento_previsto': $campoNormalizado = 'Orçamento Previsto';
        break;
        case 'user_id_responsavel': $campoNormalizado = 'Servidor(a) Responsável';
        break;
        case 'user_id_substituto': $campoNormalizado = 'Servidor(a) Substituto(a)';
        break;
        case 'dsc_indicador': $campoNormalizado = 'Descrição do Indicador';
        break;
        case 'dsc_formula': $campoNormalizado = 'Fórmula do Indicador';
        break;
        case 'dsc_unidade_medida': $campoNormalizado = 'Unidade de Medida do Indicador';
        break;
        case 'bln_acumulado': $campoNormalizado = 'Esse indicador terá o resultado acumulado?';
        break;
        case 'dsc_tipo': $campoNormalizado = 'Análise do Indicador (Polaridade)';
        break;
        case 'dsc_fonte': $campoNormalizado = 'Fonte';
        break;
        case 'dsc_periodo_medicao': $campoNormalizado = 'Período de medição';
        break;
        case 'num_ano_base_1': $campoNormalizado = 'Ano da linha base';
        break;
        case 'num_linha_base_1': $campoNormalizado = 'Valor da linha de base';
        break;
        case 'cod_plano_de_acao': $campoNormalizado = 'Plano de Ação';
        break;
        case 'dsc_grau_satisfcao': $campoNormalizado = 'Descrição do Grau de Satisfação';
        break;
        case 'framework_css': $campoNormalizado = 'Qual framework CSS utilizada';
        break;
        case 'cor': $campoNormalizado = 'Cor para representar o Grau de Satisfação';
        break;
        case 'vlr_minimo': $campoNormalizado = 'Percentual mínimo aceitável';
        break;
        case 'vlr_maximo': $campoNormalizado = 'Percentual máximo aceitável';
        break;
        case '': $campoNormalizado = '';
        break;
        case '': $campoNormalizado = '';
