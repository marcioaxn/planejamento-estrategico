...
function descricaoPermissao($permissao)
{
    ...
    switch ($permissao) {
        case '1':
            $descricaoPermissao = 'Super Administrador - Pessoa que possui o maior nível de acesso ao sistema, com a possibilidade de incluir novas organizaçoes, incluir\administrar usuários, em qualquer nível de acesso e em qualquer organização. Observa e pode atuar como administrador\gestor nos projetos.';
            break;
        case '2':
            $descricaoPermissao = 'Gestor - Pessoa que atua na gestão dos projetos que estão sob sua responsabilidade.';
            break;
    }
...
function descricaoCurtaPermissao($permissao)
{
    ...
    switch ($permissao) {
        case '1':
            $descricaoPermissao = 'Super Administrador';
            break;
        case '2':
...
function nomeCampoTabVisMdrNormalizado($campo)
{
    ...
    switch ($campo) {
        ...
        case 'uf':
            ...
            break;
        case 'cod_mdr':
            $campoNormalizado = 'Código Interno MDR';
            break;
        case 'cod_cipi':
        ...
        case 'bln_empreendimento_estrategico':
            ...
            break;
        case 'cod_resultado_primario':
            $campoNormalizado = 'RP - Resultado Primário';
            break;
        case 'ano_orcamentario':
            $campoNormalizado = 'Ano Orçamentário';
            break;
        case '':
            $campoNormalizado = '';
            break;
...
function nomeCampoTabelaNormalizado($campo)
{
    ...
    switch ($campo) {
        ...
        case 'nom_organizacao':
            $campoNormalizado = 'Nome da Unidade';
            break;
        case 'sgl_organizacao':
            $campoNormalizado = 'Sigla da Unidade';
            break;
        case 'rel_cod_organizacao':
            $campoNormalizado = 'Vinculada ou Subordinada a qual Unidade?';
            break;
        case 'dsc_pei':
            $campoNormalizado = 'Descrição do PEI';
            break;
        case 'num_ano_inicio_pei':
            $campoNormalizado = 'Ano de Incialização do PEI';
            break;
        case 'num_ano_fim_pei':
            $campoNormalizado = 'Ano de Finalização do PEI';
            break;
        case 'dsc_missao':
            $campoNormalizado = 'Missão';
            break;
        case 'dsc_visao':
        ...
        case 'dsc_perspectiva':
            $campoNormalizado = 'Perspectiva';
            break;
        case 'dsc_objetivo_estrategico':
            $campoNormalizado = 'Objetivo Estratégico';
            break;
        case 'num_nivel_hierarquico_apresentacao':
            $campoNormalizado = 'Código';
            break;
        case 'cod_objetivo_estrategico':
            $campoNormalizado = 'Objetivo Estratégico';
            break;
        case 'cod_tipo_execucao':
            $campoNormalizado = 'Tipo';
            break;
        case 'num_nivel_hierarquico_apresentacao':
            $campoNormalizado = 'Código';
            break;
        case 'cod_organizacao':
            $campoNormalizado = 'Unidade Responsável';
            break;
        case 'dsc_plano_de_acao':
            $campoNormalizado = 'Descrição';
            break;
        case 'txt_principais_entregas':
            $campoNormalizado = 'Principais entregas';
            break;
        case 'dte_inicio':
            $campoNormalizado = 'Data de Início';
            break;
        case 'dte_fim':
        ...
        case 'bln_status':
            ...
            break;
        case 'vlr_orcamento_previsto':
            $campoNormalizado = 'Orçamento Previsto';
            break;
        case 'user_id_responsavel':
            $campoNormalizado = 'Servidor(a) Responsável';
            break;
        case 'user_id_substituto':
            $campoNormalizado = 'Servidor(a) Substituto(a)';
            break;
        case 'dsc_indicador':
            $campoNormalizado = 'Descrição do Indicador';
            break;
        case 'dsc_formula':
            $campoNormalizado = 'Fórmula do Indicador';
            break;
        case 'dsc_unidade_medida':
            $campoNormalizado = 'Unidade de Medida do Indicador';
            break;
        case 'bln_acumulado':
            $campoNormalizado = 'Esse indicador terá o resultado acumulado?';
            break;
        case 'dsc_tipo':
            $campoNormalizado = 'Análise do Indicador (Polaridade)';
            break;
        case 'dsc_fonte':
            $campoNormalizado = 'Fonte';
            break;
        case 'dsc_periodo_medicao':
            ...
            break;
        case 'num_ano_base_1':
            $campoNormalizado = 'Ano da linha base';
            break;
        case 'num_linha_base_1':
            $campoNormalizado = 'Valor da linha de base';
            break;
        case 'cod_plano_de_acao':
            $campoNormalizado = 'Plano de Ação';
            break;
        case 'dsc_grau_satisfcao':
            $campoNormalizado = 'Descrição do Grau de Satisfação';
            break;
        case 'framework_css':
            $campoNormalizado = 'Qual framework CSS utilizada';
            break;
        case 'cor':
            $campoNormalizado = 'Cor para representar o Grau de Satisfação';
            break;
        case 'vlr_minimo':
            $campoNormalizado = 'Percentual mínimo aceitável';
            break;
        case 'vlr_maximo':
...
function tipoPerfil($cod_adm = '')
{
    ...
    if (isset($cod_adm) && !is_null($cod_adm) && $cod_adm != '') {

        switch ($cod_adm) {

            case 1:
                $descricao = "<strong>Administrador(a)</strong>: terá autorização para acessar, incluir, editar e excluir todos os itens contidos no menu Administração do Sistema.";
                break;

            case 2:
                $descricao = "<strong>Gestor(a)</strong>: poderá apenas efetuar a gestão dos Indicadores de Monitoramento do(s) Plano(s) de Ação(ões) onde estiver como Servidor(a) Responsável ou como Servidor(a) Substituto(a).";
                break;
