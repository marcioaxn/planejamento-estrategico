...
class MissaoVisaoLivewire extends Component
{
    ...
    public $cod_missao_visao_valores = null;
    public $dsc_missao = null;
    public $dsc_visao = null;
    public $cod_pei = null;
    ...
    public function create() {
        ...
        if(!$this->editarForm) {
            ...
            $editar = MissaoVisao::find($this->cod_missao_visao_valores);
    ...
    public function editForm(MissaoVisao $singleData) {
    ...
    public function deleteForm(MissaoVisao $singleData) {
        ...
        $texto .= '<p class="my-2 text-gray-500 text-xs leading-relaxed">Missão: <strong>'.$singleData->dsc_missao.'</strong></p><p class="my-2 text-gray-500 text-xs leading-relaxed">Visão: <strong>'.$singleData->dsc_visao.'</strong></p><p class="my-2 text-gray-500 text-xs leading-relaxed">Planejamento: <strong>'.$consultarPei->dsc_pei.'</strong></p><p class="my-2 text-gray-500 text-xs leading-relaxed">Unidade: <strong>'.$consultarOrganizacao->nom_organizacao.'</strong></p><p class="my-2 text-gray-500 text-xs font-semibold leading-relaxed text-red-600">Quer realmente excluir?</p>';
    ...
    public function delete(MissaoVisao $singleData) {
        ...
        $modificacoes = $modificacoes.'<p class="my-2 text-gray-500 text-xs leading-relaxed">A Missão <strong>'.$singleData->dsc_missao.'</strong> e a Visão <strong>'.$singleData->dsc_visao.'</strong> da Unidade <strong>'.$consultarOrganizacao->nom_organizacao.'</strong> e do Planejamento Estratégico Integrado <strong>'.$consultarPei->dsc_pei.'</strong> foi excluído com sucesso.</p>';
    ...
    public function render()
    {
        ...
        $MissaoVisao = MissaoVisao::orderBy('dsc_missao','desc')
