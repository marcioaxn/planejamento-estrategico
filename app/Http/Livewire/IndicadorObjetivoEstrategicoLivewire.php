...
class IndicadorObjetivoEstrategicoLivewire extends Component
{
    ...
    public function getObjetivoEstrategico($codObjetivoEstrategico = null)
    {
        if (isset($codObjetivoEstrategico) && !empty($codObjetivoEstrategico)) {
            return ObjetivoEstrategico::with('fututosAlmejados', 'primeiroIndicador', 'primeiroIndicador.linhaBase', 'primeiroIndicador.metaAno', 'primeiroIndicador.evolucaoIndicador', 'indicadores')
    ...
    public function editForm($cod_evolucao_indicador = null)
    {

        dd("Aqui 8", $cod_evolucao_indicador);

    }

    public function testar($cod_evolucao_indicador = null)
    {
    ...
    public function render()
    {
        ...
        // dd("Aqui 8", $this->ano, $this->cod_plano_de_acao, $this->organization);
    }
